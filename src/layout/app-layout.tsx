...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'program-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Fundings', path: '/fundings', entity: 'funding', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
    { name: 'Programs', path: '/programs', entity: 'program', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
