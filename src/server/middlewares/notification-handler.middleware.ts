...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order.create.create': { roles: ['business-owner', 'program-manager'], key: 'order', tenantPath: [], userPath: [] },
  'order.update.update': { roles: ['business-owner', 'program-manager'], key: 'order', tenantPath: [], userPath: [] },
  'product.create.create': {
    roles: ['business-owner', 'program-manager'],
    key: 'product',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['business-owner', 'program-manager'];
