...
import { getFundingById } from 'apiSdk/fundings';
import { FundingInterface } from 'interfaces/funding';

function FundingViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('funding', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/fundings/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem
                  label="Funding Date"
                  text={
                    data?.funding_date ? format(parseISO(data?.funding_date as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />

                <FormListItem label="Funding Status" text={data?.funding_status} />
