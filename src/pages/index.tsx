  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Kundenportal - Your go-to online platform for applying to funding programs, designed to make the process simpler, faster and more efficient."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1593510987760-2d895bc8109d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmdW5kaW5nfGVufDB8fHx8MTY5NTgyMTAxM3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Kundenportal - Your go-to online platform for applying to funding programs, designed to make the process simpler, faster and more efficient.`}
            </Text>
            <Box
