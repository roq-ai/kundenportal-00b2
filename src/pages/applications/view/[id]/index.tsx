...
import { FundingListPage } from 'pages/fundings';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem
                  label="Approval Date"
                  text={
                    data?.approval_date ? format(parseISO(data?.approval_date as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />
                ...
                <FormListItem
                  ...
                  text={
                    data?.rejection_date
                      ? format(parseISO(data?.rejection_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
                ...
                {hasAccess('program', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Program"
                    text={
                      <Link as={NextLink} href={`/programs/view/${data?.program?.id}`}>
                        {data?.program?.name}
                      </Link>
                    }
                  />
